...
$(function () {
    ...
    var usrinfo, nameDict;
    //读取数据
    $.ajaxSettings.async = false; //关闭异步执行
    $.getJSON('usrdata/usrinfo20190413.json', function (json) {
        usrinfo = json;
    });
    $.getJSON('usrdata/nameDict20190417.json', function (json) {
        nameDict = json;
    });
